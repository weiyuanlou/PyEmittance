...
from pyemittance.bunch_length_calc import BunchLengthCalc

# Sample emittance scan function for machine and injector surrogate

def eval_bunch_length_machine(config,
                      phase_init = [-6, -4, -2, 0],
                      online = False,
                      name = 'LCLS',
                      meas_type = 'OTRS',
    ...
    bs_x_list, bs_y_list, bs_x_list_err, bs_y_list_err = o.measure_beam(phase_init)
...
def eval_bunch_length_surrogate(get_bs_model,
                        config,
                        quad_init = [-6, -4, -2, 0],
                        adapt_ranges = True,
                        num_points = 7,
